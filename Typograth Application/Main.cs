...
namespace Typograth_Application
{
    public partial class mainForm : Form
    {
        ...
        public string rule_space(string str)
        {
            str.Trim();
        ...
        public string rule_degree(string str)
        {
            str = str.Replace("^2", "\u00B2");
            str = str.Replace("^3", "\u00B3");
            return str;
        }
        public string rule_multdots(string str)
        {
            str = str.Replace("...", "\u2026");
            return str;
        }
        public string rule_quots(string str)
        {
            var str1 = Regex.Replace(str, "\"(.+?)\"", "\u276E$1\u276F");
            return str1.ToString();
        }
        public string rule_arrow(string str)
        {
            str = str.Replace("->", "\u279E");
            return str;
        }
        public string rule_tab(string str)
        {
            str = str.Replace("\u0009", "\u2022");
            return str;
        }
        public string rule_sigma(string str)
        {
